...
- サポートされているAIコーディングエージェント: [Claude Code](#-claude-code) | [OpenClaw](#-openclaw) | [OpenCode](#-opencode) | [Codex](#-codex) | [Qodercli](#-qodercli) | [GitHub Copilot CLI](#-copilotcli) | [その他のプラットフォーム](#-その他のプラットフォーム近日公開)
...
<summary><h4 id="-copilotcli">⚡ GitHub Copilot CLI <sup><code>コミュニティ</code></sup></h4></summary>
**ステップ1: プラグインのインストール**
